...
public class KontaktlisteMitBearbeiten_try_finally extends JFrame {
...
//    private String dateiname = "./kontakte.dat";
	...
	EventQueue.invokeLater(new Runnable() {
	    public void run() {
		try {
		  KontaktlisteMitBearbeiten_try_finally frame = new KontaktlisteMitBearbeiten_try_finally();
     ...
     * Create the frame.
     */
    public KontaktlisteMitBearbeiten_try_finally() {
