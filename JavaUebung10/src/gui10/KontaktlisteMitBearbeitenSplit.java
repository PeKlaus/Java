...
public class KontaktlisteMitBearbeitenSplit extends JFrame {
	...
	EventQueue.invokeLater(new Runnable() {
	    public void run() {
		try {
		    KontaktlisteMitBearbeitenSplit frame = new KontaktlisteMitBearbeitenSplit();
     ...
     * Create the frame.
     */
    public KontaktlisteMitBearbeitenSplit() {
